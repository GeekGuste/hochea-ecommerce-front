<template>
  <div class="container">
    <h1><center><u>Politique de vente</u></center></h1>
    <p>
      L'offre et la vente de produits sur hocheacreation.fr sont régies par les présentes Conditions Générales de Vente. <br>
      Les produits achetés sur hocheacreation.fr sont fabriqués et vendus directement par Hochea creation. <br>

      La marque Hochea creation a son siège social au 15 rue de Soleure 67000 Strasbourg France. <br>
      Hochea creation est immatriculée à LA CHAMBRE DE MÉTIERS ET DE L'ARTISANAT DE Strasbourg sous le N° de Siret 84286645100011  <br>
      Hochea creation met à la vente sur hocheacreation.fr des produits fabriqués artisanalement et pratique sa propre activité de commerce électronique exclusivement à l'égard du "consommateur final". <br>
      Par "consommateur final", est désignée toute personne physique qui opère à des fins étrangères à toute activité d'entreprise ou professionnelle éventuellement pratiquée. <br>
    ...
    <p>
      ...
      Par conséquent, hocheacreation.fr ne peut être tenu pour responsable d'erreurs ou d'inexactitudes des photographies ou des représentations graphiques des produits figurant sur le site hocheacreation.fr<br>
    ...
    <br>
    <h2>Clause n°6 : Paiement</h2>
    <p>
      Les moyens de paiements sécurisés disponibles sur la boutique Hochea creation sont :
      <ul>
        <li>les cartes bancaires Visa, Mastercard,</li>
        <li>Paypal</li>
        <li>Scala (A venir)</li>
        <li>Klarna (A venir)</li>
      </ul>      
    </p>
    <br>
    ...
    <p>
      ...
      Vous disposez d'un délai de 14 jours à compter de la date de réception pour nous renvoyer les produits.<br>
      Merci de contacter le service client par email à hocheacreation@gmail.com avant de retourner un article. Nous vous communiqueront l'adresse à laquelle renvoyer le colis.<br>
      Les frais de retours postaux sont à la charge de l'acheteur.<br>
      Des frais de douanes pourront être retenus en cas de retour depuis un pays hors Union Européenne.<br>
    ...
    <p>
      Tous les textes, commentaires, ouvrages, illustrations et images reproduits sur le site hocheacreation.fr sont réservés au titre du droit d'auteur ainsi qu'au titre de la propriété intellectuelle pour le monde entier.<br>
      A ce titre, conformément aux dispositions du Code de la Propriété intellectuelle, seule l'utilisation pour un usage privé est tolérée.<br>
      Toute autre utilisation est constitutive de contrefaçon et sanctionnée au titre de la Propriété Intellectuelle sauf disposition préalable de hocheacreation.fr.<br>
      Toute reproduction totale ou partielle du catalogue de hocheacreation.fr est strictement interdite.<br>
      Tous droits réservés.
    </p>
    <br>
    <h2>Clause n°9: Protection des données personnelles</h2>
    <p>
      hocheacreation.fr s'engage à ne pas divulguer à des tiers les informations que vous lui communiquez.<br>
      Celles-ci restent confidentielles. Elles ne seront utilisées par nos services internes que pour le traitement de votre commande, personnaliser la communication, notamment par les lettres d'information de hocheacreation.fr si vous en êtes abonnés.<br>
      En conséquence, et conformément à la loi informatique et libertés du 6 janvier 1978 (déclaration numéro 1733208 v 0 ), vous disposez d'un droit d'accès, de rectification, et d'opposition aux données personnelles vous concernant.<br>
      Pour cela, il vous suffit de nous en faire la demande en ligne ou par courrier, en nous indiquant votre nom, prénom, adresse à :<br>
      Hochea creation<br>
      15 rue de Soleure, 67000 Strasbourg<br>
      hocheacreation@gmail.com
    </p>
  </div>
</template>