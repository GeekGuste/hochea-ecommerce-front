  ...
  <div>
    <h2>
      <center>
        ...
        <b-button to="/admin/delivery/zone/new" variant="success"
          >Ajouter une zone +</b-button
        >
      </center>
    </h2>
    <div>
      <table class="table table-hover">
        ...
        <tbody>
          <tr v-for="deliveryZone in deliveryZones" :key="deliveryZone.id">
            ...
            <td>
              <NuxtLink
                :to="'/admin/delivery/zone/' + deliveryZone.id + '/edit'"
...
onMounted(() => {
  useFetch('/api/deliveryZoneInfo/').then(
    (deliveryZoneList: PaginatedList<DeliveryZoneInfo>) => {
      deliveryZones.value = deliveryZoneList.results
    }
  )
})
</script>
